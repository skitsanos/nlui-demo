...
# Both upload and generated demo-data locations must be writable by the
# unprivileged runtime user. Persist /app/data when demo mutations must survive
# a container restart.
RUN mkdir -p /app/uploads /app/data && chown -R bun:bun /app/uploads /app/data
